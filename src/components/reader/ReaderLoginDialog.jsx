            ...
            {mode !== 'recovery' && (
              <>
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 border-2 border-gray-300 px-4 py-2.5 text-sm font-bold hover:border-juve-gold transition-colors"
                >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs text-gray-400 font-bold uppercase tracking-widest">oppure</span>
                  <div className="flex-1 h-px bg-gray-200" />
                </div>
              </>
            )}
